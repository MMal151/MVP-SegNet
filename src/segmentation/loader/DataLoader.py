...
from src.segmentation.generators.NiftiGenerator import Nifti3DGenerator
from src.utils.CommonUtils import is_valid_dir, is_valid_file, str_to_tuple
...
def load_data(cfg):
    ...
    if len(str_to_tuple(cfg["data"]["input_shape"])) == 3:
